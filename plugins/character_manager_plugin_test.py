...
# このファイルが直接実行されるのを防ぐおまじない
if __name__ == "__main__":
    raise ImportError("This file should not be run directly.")

# IPlugin と NovelGameEditor はメインアプリから自動的に注入されるので、
# ここでは型ヒントのためだけに定義しておく（プログラムの動作には影響しない）
